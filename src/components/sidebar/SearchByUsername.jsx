                    ...
                    <form onSubmit={SearchUser}>
                        <div className="">
                            ...
                            <div className="flex gap-2 md:gap-4">
                                <input placeholder="Enter fullname" className="appearance-none block w-48 md:w-64 bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4" required="required" type="text" ref={searchRef} />
